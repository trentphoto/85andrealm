...
export default function SidebarCategoryItem({ category, isActive = false, onItemClick }: { category: Category, isActive: boolean, onItemClick: (arg0: number) => void }) {
    ...
    return (
        <div key={category.id} className="p-4 py-2 rounded-xl cursor-pointer hover:bg-gray-100 flex items-center gap-2" onClick={handleCheck}>

            {
                isActive ? (
                    <svg width={20} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="#16a34a">
